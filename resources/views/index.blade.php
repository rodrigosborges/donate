				        ...
				        <div class="collapse navbar-collapse" id="navbar-horizontal">
				          <ul class="navbar-nav ml-auto">
				            <li class="nav-item mx-0 mx-lg-1">
				              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Registrar</a>
				            </li>
				            <li class="nav-item mx-0 mx-lg-1">
				        ...
				        <div id="mySidenav" class="sidenav">
				        	...
				        	<form id="form-login">
							  <div class="form-group text-center">
							    <label for="formGroupExampleInput" class="fonte-branca">Nome de Usuário</label>
							    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Informe o seu usuário">
							  </div>
							  <div class="form-group text-center">
							    <label for="formGroupExampleInput2" class="fonte-branca">Senha</label>
							    <input type="password" class="form-control" id="formGroupExampleInput2" placeholder="Informe a sua senha">
							  </div>
							</form>
						</div>
						<!-- ######################## -->
